...
// Remove the list parser, as it does nothing but create trouble
simpleMarkdown.defaultRules.list = {
	order: Number.POSITIVE_INFINITY,
	match: (source) => null	// Never match anything in order to ignore this rule
	// Nothing will ever match, so the rest of the functions will never be called
}
