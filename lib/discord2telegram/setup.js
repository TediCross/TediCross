 ...
 */
function setup(logger, dcBot, tgBot, messageMap, bridgeMap, settings, datadir) {
	// Create the map of latest message IDs and bridges
	const latestDiscordMessageIds = new LatestDiscordMessageIds(logger, "latestDiscordMessageIds.json", datadir);
