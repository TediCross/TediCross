...
class Bridge {
	 ...
	 * @param {Boolean} bridgeSettings.telegram.relayJoinMessages	Whether or not to relay join messages from Telegram to Discord
	 * @param {Boolean} bridgeSettings.telegram.relayLeaveMessages	Whether or not to relay leave messages from Telegram to Discord
	 ...
	 * @param {Boolean} bridgeSettings.discord.relayJoinMessages	Whether or not to relay join messages from Discord to Telegram
	 * @param {Boolean} bridgeSettings.discord.relayLeaveMessages	Whether or not to relay leave messages from Discord to Telegram
	 */
	constructor(bridgeSettings) {
		...
		this.telegram = {
			...
			relayJoinMessages: bridgeSettings.telegram.relayJoinMessages,
			relayLeaveMessages: bridgeSettings.telegram.relayLeaveMessages
		};
		...
		this.discord = {
			...
			relayJoinMessages: bridgeSettings.discord.relayJoinMessages,
			relayLeaveMessages: bridgeSettings.discord.relayLeaveMessages
		};
	}
