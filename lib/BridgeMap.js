...
class BridgeMap {
	constructor(bridgeMap) {
		// Make sure all Telegram chat IDs are integers	TODO Check if this is even necessary, or just something I thought would make sense
		for (const map of bridgeMap) {
			map.telegram = Number.parseInt(map.telegram);
		}
