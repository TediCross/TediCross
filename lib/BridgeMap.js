...
class BridgeMap {
	...
	constructor(bridges) {
		...
		bridges.forEach((bridge) => {
			this._discordToBridge.set(bridge.discordChannelId, bridge);
			this._telegramToBridge.set(bridge.telegramChatId, bridge);
			this._discordServers.add(bridge.discordServerId);
		});
	}
