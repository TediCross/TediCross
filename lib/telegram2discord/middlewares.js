...
/**
 * Adds a boolean telling if the message is an edit 
 *
 * @param {Object} ctx	The context to add the property to
 * @param {Object} ctx.tediCross	The tedicross object on the context
 * @param {Object} ctx.tediCross.message	The message being handled
 * @param {Function} next	Function to pass control to next middleware
 *
 * @returns {undefined}
 */
function addEditBool(ctx, next) {
	ctx.tediCross.isEdit = !R.isNil(ctx.tediCross.message.edit_date);
